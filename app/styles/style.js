const styles = {
  ...
  heading3:
    "font-poppins font-semibold md:text-[16px] text-[14px] leading-auto",
  button:
    "font-poppins font-semibold md:text-[16px] text-[14px] leading-auto",
  paragraph:
    "font-poppins font-semibold md:text-[18px] text-[16px] leading-auto ",
  paragraph_m:
    "font-poppins font-medium md:text-[18px] text-[16px] leading-auto",
  subtitle:
    "font-poppins font-normal md:text-[12px] text-[10px] leading-auto",
  placeholder:
    "font-poppins font-medium md:text-[14px] text-[12px] leading-auto",
